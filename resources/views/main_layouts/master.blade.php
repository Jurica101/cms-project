...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="{{ asset('cms_template/css/animate.css') }}">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{ asset('cms_template/css/icomoon.css') }}">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="{{ asset('/cms_template/css/bootstrap.css') }}">

    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ asset('cms_template/css/magnific-popup.css') }}">

    <!-- Flexslider  -->
    <link rel="stylesheet" href="{{ asset('cms_template/css/flexslider.css') }}">

    <!-- Owl Carousel -->
    <link rel="stylesheet" href="{{ asset('cms_template/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('cms_template/css/owl.theme.default.min.css') }}">

    <!-- Flaticons  -->
    <link rel="stylesheet" href="{{ asset('cms_template/fonts/flaticon/font/flaticon.css') }}">

    <!-- Theme style  -->
    <link rel="stylesheet" href="{{ asset('cms_template/css/style.css') }}">

    <link rel="stylesheet" href="{{ asset('css/mystyle.css') }}">

    <!-- Modernizr JS -->
    <script src="{{ asset('cms_template/js/modernizr-2.6.2.min.js') }}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    ...
    <div id="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 text-right menu-1">
                            <ul>
                                ...
                                @guest
                                <li class="btn-cta"><a href="{{ route('login') }}"><span>Log in</span></a></li>
        ...
        <div id="colorlib-subscribe" class="subs-img" style="background-image: url({{ asset('cms_template/images/img_bg_2.jpg') }});" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
                <div class="row row-pb-md">
                    ...
                    <div class="col-md-3 colorlib-widget">
                        <h4>Recent Post</h4>
                        <div class="f-blog">
                            <a href="blog.html" class="blog-img" style="background-image: url({{ asset('cms_template/images/blog-1.jpg') }});">
                            </a>
                            <div class="desc">
                        ...
                        <div class="f-blog">
                            <a href="blog.html" class="blog-img" style="background-image: url({{ asset('cms_template/images/blog-2.jpg') }});">
                            </a>
                            <div class="desc">
                                <h2><a href="blog.html">Creating Mobile Apps</a></h2>
                                <p class="admin"><span>18 April 2018</span></p>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small><br>
    ...
    <!-- jQuery -->
    <script src="{{ asset('cms_template/js/jquery.min.js') }}"></script>
    <!-- jQuery Easing -->
    <script src="{{ asset('cms_template/js/jquery.easing.1.3.js') }}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('cms_template/js/bootstrap.min.js') }}"></script>
    <!-- Waypoints -->
    <script src="{{ asset('cms_template/js/jquery.waypoints.min.js') }}"></script>
    <!-- Stellar Parallax -->
    <script src="{{ asset('cms_template/js/jquery.stellar.min.js') }}"></script>
    <!-- Flexslider -->
    <script src="{{ asset('cms_template/js/jquery.flexslider-min.js') }}"></script>
    <!-- Owl carousel -->
    <script src="{{ asset('cms_template/js/owl.carousel.min.js') }}"></script>
    <!-- Magnific Popup -->
    <script src="{{ asset('cms_template/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('cms_template/js/magnific-popup-options.js') }}"></script>
    <!-- Counters -->
    <script src="{{ asset('cms_template/js/jquery.countTo.js') }}"></script>
    <!-- Main -->
    <script src="{{ asset('cms_template/js/main.js') }}"></script>
